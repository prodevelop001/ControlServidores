...
<div>
    ...
    <asp:Panel ID="pnlFormIntRed" CssClass="miFormulario" Visible="false" runat="server">
        ...
        <div class="formCampos">
            ...
            <asp:TextBox ID="txtDirMAC" runat="server" placeholder="Ej: 00:00:00:00:00:00:00:00"></asp:TextBox>
        ...
        <div class="formCampos">
            ...
            <asp:TextBox ID="txtDirIP" runat="server" placeholder="Ej: 10.1.65.84"></asp:TextBox>
        ...
        <div class="formCampos">
            ...
            <asp:TextBox ID="txtMascaraSubRed" runat="server" placeholder="Ej: 255.255.255.0"></asp:TextBox>
        ...
        <div class="formCampos">
            <label>Gateway :</label>
            <asp:TextBox ID="txtGateway" runat="server" placeholder="Ej: 10.1.65.254"></asp:TextBox>
        ...
        <div class="formCampos">
            <label>VLAN :</label>
            <asp:TextBox ID="txtVlan" runat="server" placeholder="Ej: 9"></asp:TextBox>
        </div>
        <div class="formCampos">
            <label>Estatus :</label>
